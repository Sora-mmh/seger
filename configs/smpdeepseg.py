...
from configs.__base__ import cfg_common, cfg_dataset_default, cfg_model_smpdeepseg


class cfg(cfg_common, cfg_dataset_default, cfg_model_smpdeepseg):

    def __init__(self):
        cfg_common.__init__(self)
        cfg_dataset_default.__init__(self)
        cfg_model_smpdeepseg.__init__(self)
        self.seed = 42
        self.size = 640
        self.epoch_full = 100
        ...
        #     self.model.kwargs["encoder_name"], self.model.kwargs["encoder_weights"]
        # )
