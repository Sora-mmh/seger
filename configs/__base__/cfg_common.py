...
class cfg_common(Namespace):
    ...
    def __init__(self):
        ...
        self.trainer.name = "RailssegTrainer"
        ...
        self.trainer.sync_BN = "apex"  
        self.trainer.dist_BN = (
            ""  # [ , reduce, broadcast], valid when sync_BN is 'none'
        )
        self.trainer.scaler = "none"  # [none, native, apex]
        self.trainer.data = Namespace()
        self.trainer.data.batch_size = 8
        ...
        self.loss.loss_terms = [
            dict(type="DiceLoss", name="dice", avg=False, lam=1.0),
        ]
