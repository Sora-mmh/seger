...
from configs.__base__ import cfg_common, cfg_dataset_default, cfg_model_simresseg


class cfg(cfg_common, cfg_dataset_default, cfg_model_simresseg):

    def __init__(self):
        cfg_common.__init__(self)
        cfg_dataset_default.__init__(self)
        cfg_model_simresseg.__init__(self)
        self.seed = 42
        self.size = 640
        self.epoch_full = 500
        ...
        self.lr = 1e-3 * self.batch_train / 32
        ...
        self.data.train_samples = 2711
        self.data.test_samples = 462
        ...
        # "SIMRES_SegTrainer_configs_simresseg_20250115-093735"
