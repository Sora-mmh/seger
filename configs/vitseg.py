...
from configs.__base__ import cfg_common, cfg_dataset_default, cfg_model_vitseg


class cfg(cfg_common, cfg_dataset_default, cfg_model_vitseg):
    def __init__(self):
        cfg_common.__init__(self)
        cfg_dataset_default.__init__(self)
        cfg_model_vitseg.__init__(self)
        self.seed = 42
        self.size = 640
        self.epoch_full = 10
        ...
        self.lr = 1e-3 * self.batch_train / 8
