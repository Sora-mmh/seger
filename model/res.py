...
def resnet18(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    ), BN_layer(AttnBasicBlock, 2, **kwargs)
...
def resnet34(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    ), BN_layer(AttnBasicBlock, 3, **kwargs)
...
class ReSSegHead(nn.Module):
    def __init__(
        ...
        super(ReSSegHead, self).__init__()
...
class ReSSeg(nn.Module):
    def __init__(self):
        ...
        self.encoder, _ = wide_resnet101_2(pretrained=False)
        # self.encoder, _ = resnet101()
        self.decoder = UNetDecoder([256, 512, 1024, 2048])
        self.seg_head = ReSSegHead(self.decoder.decoder_channels[-1])
...
def resseg(pretrained=False, **kwargs):
    model = ReSSeg(**kwargs)
    return model
